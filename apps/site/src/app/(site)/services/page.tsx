...
const description =
  "Explore our most-requested pressure washing and soft washing services. Every visit includes surface-safe methods, clear communication, and a professional finish.";

export const metadata: Metadata = {
  title: "Pressure washing services built for Georgia homes",
  description,
  openGraph: {
    title: "Pressure washing services built for Georgia homes",
    description,
    ...
    <Section>
      <div className="mx-auto max-w-5xl space-y-6">
        <header className="space-y-3">
          <Badge tone="highlight">Pressure Washing Specialists</Badge>
          <h1 className="font-display text-display text-primary-800">Pressure washing services built for Georgia homes</h1>
          <p className="text-body text-neutral-600">
            Explore our most-requested packages. Every visit includes surface-safe methods, clear communication, and a professional finish.
          </p>
        </header>
